...
// GobEncoderDecoder is an alternative Encoder/Decoder using encoding/gob for more efficient binary storage.
type GobEncoderDecoder struct{}

func (GobEncoderDecoder) Encode(w io.Writer, data any) error {
	enc := gob.NewEncoder(w)
	return enc.Encode(data)
}

func (GobEncoderDecoder) Decode(r io.Reader, data any) error {
